...
public class ShakeDetector implements SensorEventListener {
    ...
    private static  int MIN_SHAKE_ACCELERATION = 8;
    ...
    public ShakeDetector(OnShakeListener shakeListener , int min_shake_acc) {
    	mShakeListener = shakeListener;
        if(min_shake_acc == 0)
          MIN_SHAKE_ACCELERATION = 1;
       // SharedPreferences sharedPreferences = getSharedPreferences("MyData" , MODE_PRIVATE);
        else
        MIN_SHAKE_ACCELERATION = min_shake_acc;
        Log.d("vishank" , "MIN"+MIN_SHAKE_ACCELERATION);
    }
