    ...
    private void getRepaetDays(ProfileViewHolder holder, ArrayList<ProfilesList> profileParcel2, int position) {
        ...
        if (arrayList.get(position).getMon() == 1) {
            ...
            if (arrayList.get(position).getTue() == 0 && arrayList.get(position).getWed() == 0
                    ...
                    && arrayList.get(position).getSat() == 0 && (arrayList.get(position).getSun() == 1))
                check = "or";
        ...
        if (arrayList.get(position).getTue() == 1) {
            ...
            if (arrayList.get(position).getWed() == 0
                    && arrayList.get(position).getThur() == 0 && arrayList.get(position).getFri() == 0
                    && arrayList.get(position).getSat() == 0 && (arrayList.get(position).getSun() == 1 || arrayList.get(position).getMon() == 1))
                check = "or";
        ...
        if (arrayList.get(position).getWed() == 1) {
            ...
            if (arrayList.get(position).getThur() == 0 && arrayList.get(position).getFri() == 0
                    && arrayList.get(position).getSat() == 0 && (arrayList.get(position).getSun() == 1 || arrayList.get(position).getMon() == 1 || arrayList.get(position).getTue() == 1))
                check = "or";
        ...
        if (arrayList.get(position).getThur() == 1) {
            ...
            if (arrayList.get(position).getFri() == 0
                    && arrayList.get(position).getSat() == 0 && (arrayList.get(position).getSun() == 1 || arrayList.get(position).getMon() == 1 || arrayList.get(position).getTue() == 1 || arrayList.get(position).getWed() == 1))
                check = "or";
        ...
        if (arrayList.get(position).getFri() == 1) {
            ...
            if (arrayList.get(position).getSat() == 0 && (arrayList.get(position).getSun() == 1 || arrayList.get(position).getMon() == 1 || arrayList.get(position).getTue() == 1 || arrayList.get(position).getWed() == 1 || arrayList.get(position).getThur() == 1))
                check = "or";
